...
<body>
        ...
        <nav class="nav-bar">
            ...
            <div class="nav-list">
                <ul>
                    ...
                    <li class="nav-item"><a href="ebook-bibliotecario.php" class="nav-link">Ebook</a></li>
                ...
                <div class="dropdown">
                    ...
                    ?>
                    <img src="<?php echo $percorrer['fotoperfil'] ?>" width="50" height="50" border="0" alt="Perfil">
                    <?php 
                    }
                    ?>
            ...
            <div class="login-button">
                <button>
                    <a href="index.php"><strong>Saír</strong></a>
                </button>
            </div>
    ...
    <section class="banner">
        ...
        <div class="texto"> 
            ...
            <br>
            <h2 class="sub-titulo">Painel Administrativo/Bibliotecário</h2>
        </div>
