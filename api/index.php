        ...
        <nav class="nav-bar">
            ...
            <div class="nav-list">
                <ul>
                    ...
                    <li class="nav-item"><a href="sobre.php" class="nav-link">Sobre o Elsamina</a></li>
                    <li class="nav-item"><a href="login-alunos.php" class="nav-link">Alunos</a></li>
                    <li class="nav-item"><a href="login-admin.php" class="nav-link">Administradores</a></li>
                </ul>
            </div>
