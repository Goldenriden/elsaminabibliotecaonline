...
if ( isset($_GET['rem']))
{
  ...
  $result_usuario11 = "DELETE FROM  tbusuarios  Where id ='$idrem'  ";
  $resuladotodapesquisa11 = mysqli_query ($conn, $result_usuario11);
  header('Location:list-usuarios.php?idq=token&Leila=eGmdHit0-1mde6');
...
<html lang="pt-br">
	<head>
    	...
    	<div class="col-sm-4">
                          ...
                          <p align="center">   <strong> Usuários </strong> 
...
$result_usuariosbalancotpa = "SELECT * FROM tbusuarios    ";
...

  {
   ?>                     <div class="p-30 card-view">
                        ...
                        <table border="0" width="100%" class="table table-striped table-hover col-md-12 col-sm-12 col-xs-12">
						            <tr>
                             <td>   <p align="left">   <strong>  <?php  echo $linha1['usuario']; ?> </strong>    </p>
                          </td>
                           </tr>
                           ...
                           <tr>
                           <td>
        <a href="list-usuarios.php?rem=<?php echo  $linha1['id'] ;  ?>">
