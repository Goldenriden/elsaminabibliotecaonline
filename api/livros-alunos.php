...
if ( isset($_GET['rem']))
{
  ...
  header('Location:livros-alunos.php?idq=token&Leila=eGmdHit0-1mde6');
...
<html lang="pt-br">
 ...
 <a href="index-aluno.php"  style="float: left; margin-bottom: 10px"> <b>   Página Inicial   </b></a>
...
<tr>
  ...
  <tr>
        ...
        <a href="livros-coment-alunos.php?coment=<?php echo  $linha1['id'] ;  ?>">
