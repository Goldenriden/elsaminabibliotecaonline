...
if (isset($_POST['comentar']) )
 {
            ...
            header("Location:livros-coment-alunos.php?coment=$idpub");
            exit;
    ...
    if (isset($_GET['rem1']) )
     {
      $idpub = mysqli_real_escape_string($conexao, $_POST['idpub']);  
        ...
        $id = filter_input(INPUT_GET, 'rem1', FILTER_SANITIZE_STRING);	
           ...
           header("Location:livros-alunos.php");
            exit;
        }
    ?>
...
<html lang="pt-br">
 ...
 <a href="livros-alunos.php"  style="float: left; margin-bottom: 10px"> <b>   Voltar   </b></a>
